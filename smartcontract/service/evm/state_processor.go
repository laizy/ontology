...
func applyTransaction(msg types.Message, statedb *storage.StateDB, header *otypes.Header, tx *types.Transaction, usedGas *uint64, evm *evm.EVM, feeReceiver common.Address) (*types2.ExecutionResult, *otypes.Receipt, error) {
...
func ApplyTransaction(config *params.ChainConfig, bc store.LedgerStore, statedb *storage.StateDB, header *otypes.Header, tx *types.Transaction, usedGas *uint64, feeReceiver common.Address, cfg evm.Config) (*types2.ExecutionResult, *otypes.Receipt, error) {
