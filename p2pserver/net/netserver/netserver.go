...
func (this *NetServer) Start() {
	...
	ctx := protocols.NewContext(nil, this, 0)
...
func (this *NetServer) removeOldPeer(kid kbucket.KadId, remoteAddr string) {
	...
	if p != nil {
		...
		if delOK {
			...
			this.notifyPeerDisConnected(n.Info)
		}
	}
...
func (this *NetServer) Connect(addr string) error {
	...
	this.notifyPeerConnected(remotePeer.Info)
	return nil
}

func (this *NetServer) notifyPeerConnected(p *peer.PeerInfo) {
	ctx := protocols.NewContext(nil, this, 0)
	this.protocol.HandleSystemMessage(ctx, protocols.PeerConnected{Info: p})
}

func (this *NetServer) notifyPeerDisConnected(p *peer.PeerInfo) {
	ctx := protocols.NewContext(nil, this, 0)
	this.protocol.HandleSystemMessage(ctx, protocols.PeerDisConnected{Info: p})
}
