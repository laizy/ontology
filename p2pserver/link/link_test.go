...
func init() {
	...
	cliLink = NewLink()
	serverLink = NewLink()
	id := kbucket.PseudoKadIdFromUint64(0x733936)
	cliLink.SetID(id)
	id2 := kbucket.PseudoKadIdFromUint64(0x8274950)
...
func TestNewLink(t *testing.T) {
	...
	i := kbucket.PseudoKadIdFromUint64(uint64(id))
	cliLink.SetID(i)
...
func TestUnpackBufNode(t *testing.T) {
	...
	case "addr":
		...
		for i := 0; i < 10000000; i++ {
			idd := kbucket.PseudoKadIdFromUint64(uint64(i))
